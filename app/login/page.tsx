  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to SAHAYAK.",
      })
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign in to your SAHAYAK account to continue creating amazing learning experiences.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="mt-4 bg-blue-50 border-blue-200">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-xs text-blue-600 mb-3">Email: demo@sahayak.com | Password: demo123</p>
              <Button
                onClick={() => {
                  setEmail("demo@sahayak.com")
                  setPassword("demo123")
                }}
                variant="outline"
                size="sm"
